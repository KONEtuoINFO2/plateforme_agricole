...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-success">✏️ Modifier un partenaire</h2>
        <a href="{{ route('entreprise.dashboard') }}" class="btn btn-outline-success">
            ← Retour au tableau de bord
        </a>
    </div>

    <form action="{{ route('entreprise.partenaire.update', $user->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('entreprise.partenaires') }}" class="btn btn-secondary">↩️ Retour</a>
    </form>
</div>
@endsection